...
public class FeaturesToVw {
	...
	static {
		...
		featureGroupB = new HashSet<String>(Arrays.asList("C7", "C8", "C14", "C21", "C22", "C23"));
		featureGroupC = new HashSet<String>(Arrays.asList("C15", "C3", "C10", "C25", "C26", "C20"));
		featureGroupD = new HashSet<String>(Arrays.asList("C11", "C12", "C9", "C27", "C24"));
