...
TRAIN="cat /home/pe/Public/dm3/adv/train_p.csv"
TEST="cat /home/pe/Public/dm3/adv/test_p.csv"
...
cat <(echo "Id,p1") <(paste -d"," <(tail -n +2 /home/pe/Public/dm3/adv/sample_adv.txt/sample_adv.txt | cut -f1 | cut -d"," -f1) prediction_test_Option.poly_1.txt) | $PYTHON_PATH ./scripts/submit.py
